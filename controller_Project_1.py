...
class Controller(QMainWindow, Ui_MainWindow):
    def __init__(self, *args: object, **kwargs: object) -> None:
        ...
        self.button_scissor.clicked.connect(lambda: self.update_game('Scissors'))

    def update_game(self, user_selection: str) -> None:
        """
    ...
    def update_display(self, game_info: dict) -> None:
        """
